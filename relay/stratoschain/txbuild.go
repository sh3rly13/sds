...
func BuildCreateResourceNodeMsg(networkID, token, moniker string, nodeType registertypes.NodeType, pubKey []byte, stakeAmount int64, ownerAddress utiltypes.Address) sdktypes.Msg {
	if nodeType > 7 || nodeType < 1 {
